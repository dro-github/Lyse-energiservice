package com.cts.nanoMeteringGateway;

import com.cts.nanoMeteringGateway.devicemeteringpointconnections.GetMeteringPointForDevice;
import com.cts.nanoMeteringGateway.devicemeteringpointconnections.GetUnitForMeteringPoint;
...
public class CheckUnitInNanoMetering {
    ...
    public CheckUnitInNanoMetering(List<String[]> allInputRows, JdbcTemplate jdbcTemplate, StringBuilder avvikRapport){
